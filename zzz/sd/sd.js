...
let vLive = 47, vBeta = 48, v25 = 38, v28 = 48, modeNumOld = 4, modeNum = 4;
      ...
      for (let e = 1; e <= currWave.enemies.length; ++e) {
        ...
        if (eTags.length >= 1 && !(eTags.length == 1 && eTags.includes("spoiler"))) {
          ...
          if (eTags.includes("hitch")) {
            ...
            ttHP.innerHTML = alt(color, eName, eHPNew, eHP, currEnemyData.baseDEF[currEnemyType]) + ttHP.innerHTML;
          }
          hp.appendChild(ttHP);
        }
